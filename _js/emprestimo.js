...
let v1 = document.getElementById('CVal')
let v2 = document.getElementById('CJur')
let v3 = document.getElementById('CPar')
let res = document.getElementById('res')

let valor = Number(v1.value)
let juros = Number(v2.value)
let parcelas = Number(v3.value)    
}
*/
